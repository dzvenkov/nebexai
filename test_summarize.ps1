<#
.SYNOPSIS
    Starts the NebexAI server and tests the /summarize endpoint.
.PARAMETER RepoUrl
...
Write-Host "=== NebexAI Summarize Test ===" -ForegroundColor Cyan
...
# Test /summarize
Write-Host "Testing POST /summarize..." -ForegroundColor Yellow
Write-Host "This will take a few seconds as the LLM processes the repository..." -ForegroundColor Gray
Write-Host ""
...
try {
    ...
    Write-Host "=== LLM Summary Response ===" -ForegroundColor Green
    Write-Host "Summary:" -ForegroundColor Cyan
    Write-Host $response.summary
    Write-Host ""
    Write-Host "Technologies:" -ForegroundColor Cyan
    Write-Host ($response.technologies -join ", ")
    Write-Host ""
